...
class MeaningConfigScreen extends ConsumerStatefulWidget {
  final int childId;
  const MeaningConfigScreen({super.key, required this.childId});

  @override
  ConsumerState<MeaningConfigScreen> createState() => _MeaningConfigScreenState();
}

class _MeaningConfigScreenState extends ConsumerState<MeaningConfigScreen> {
  ...
  // Common UI helpers duplicated for now
